        ...
        <div className="fixed inset-0 z-50 p-4 flex items-center justify-center bg-black/40">
              ...
              <div className="w-full max-w-4xl mx-auto rounded-2xl  bg-white p-6 shadow-xl">
                  ...
                  <div className="p-0">
                    <div className="flex flex-row gap-6">
                      ...
                      <div>
                        ...
                        <div className="border border-gray-950 rounded-xl w-70 h-10 ">
                          <select value={mainCategory} onChange={(e) => setMainCategory(e.target.value)} className="w-full h-full px-3 py-2 rounded-lg border-none outline-none">
                    ...
                    <div className="flex flex-row gap-6 mt-5">
                      <div>
                        ...
                        <div className="border border-gray-950 rounded-xl w-70 h-10 ">
                          <input type="text" placeholder="Enter sub category..." value={subCategory} onChange={(e) => setSubCategory(e.target.value)} className="w-full h-full px-3 py-2 rounded-lg border-none outline-none" />
                        </div>
                      </div>
                      <div>
                ...
                <div className="flex justify-end gap-3 mt-6">
                  <button
                    onClick={onClose}
                    className="rounded-lg border border-gray-300 px-5 py-2 cursor-pointer"
                  >
                    Cancel
                  </button>
